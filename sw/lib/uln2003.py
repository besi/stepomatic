# https://raw.githubusercontent.com/IDWizard/uln2003/master/uln2003.py
import time

LOW = 0
HIGH = 1
FULL_ROTATION = 513 # was 509 initially # http://www.jangeox.be/2013/10/stepper-motor-28byj-48_25.html
...
if __name__ == '__main__':
    ...
    s1 = Stepper(HALF_STEP, machine.Pin(16), machine.Pin(15), machine.Pin(14), machine.Pin(13), delay=5)    
    s2 = Stepper(HALF_STEP, machine.Pin(6), machine.Pin(5), machine.Pin(4), machine.Pin(3), delay=5)   
